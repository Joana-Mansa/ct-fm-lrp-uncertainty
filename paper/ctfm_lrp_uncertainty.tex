...
Grad-CAM at 0.924 and the LRP composites between $-0.015$ and 0.220. We conclude
that deletion protocols require manifold-preserving masking before they can rank
attribution methods on volumetric medical data.
\end{abstract}
...
pretrained on complete scans may not be used as intended. The uncertainty
results use MC dropout.
